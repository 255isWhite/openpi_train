...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_robotwin_clean_noopt_delta_select10",
        model=pi0.Pi0Config(),
        data=LeRobotAlohaDataConfig(
            repo_id="ROBOTWIN_CLEAN_NOOPT_DELTA_SELECT10",  # your datasets repo_id
            adapt_to_pi=False,
